  ...
  fetch(url, {
    ...
    .then(data => {
      data.forEach(element => {
        tabla.insertAdjacentHTML('beforeend', itemUnidad(element))
      })
    })
...
function itemUnidad(element) {
  ...
  item = `<tr>
          ...
          <a class="btn btn-danger" data-id="${element.IdUnidad}" title="Editar" href="" title="Eliminar"><i class="fa fa-trash"></i></a>
          </td >
      </tr>`;
  return item;
}
